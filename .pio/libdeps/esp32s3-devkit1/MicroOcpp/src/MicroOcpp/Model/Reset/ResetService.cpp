...
ResetService::ResetService(Context &context)
    ...
    context.getOperationRegistry().registerOperation("Reset", [&context]() { return new Ocpp16::Reset(context.getModel()); });
}
...
namespace MicroOcpp {
    namespace Ocpp201 {
        ...
        ResetService::ResetService(Context &context)
            ...
            context.getOperationRegistry().registerOperation("Reset", [this]() { return new Ocpp201::Reset(*this); });
        }
